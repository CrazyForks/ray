...
class RayEventRecorder : public RayEventRecorderInterface {
 ...
 private:
  ...
  // Using InlinedVector for better performance and memory locality.
  static constexpr size_t kInlineCapacity = 1000;  // 10% of typical max size
  absl::InlinedVector<std::unique_ptr<RayEventInterface>, kInlineCapacity> buffer_
